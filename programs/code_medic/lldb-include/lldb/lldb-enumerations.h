...
namespace lldb {
    ...
    {
        eLaunchFlagNone         = 0u,
        eLaunchFlagExec         = (1u << 0),       ///< Exec when launching and turn the calling process into a jnew process
        ...
        eLaunchFlagLaunchInTTY  = (1u << 5),       ///< Launch the process in a jnew TTY if supported by the host
