...
#line 91 "code/GDBVarTreeParserY.cpp"
...
#ifndef YY_YY_CODE_GDBVARTREEPARSERY_HPP_INCLUDED
# define YY_YY_CODE_GDBVARTREEPARSERY_HPP_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#line 172 "code/GDBVarTreeParserY.cpp"
...
#endif /* !YY_YY_CODE_GDBVARTREEPARSERY_HPP_INCLUDED  */
...
#line 219 "code/GDBVarTreeParserY.cpp"
...
#line 1275 "code/GDBVarTreeParserY.cpp"
...
#line 91 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, (yyvsp[-1].pGroup)->GetName());
...
#line 1476 "code/GDBVarTreeParserY.cpp"
    break;

  case 3:
#line 105 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, *(yyvsp[-2].pString));
		for (JIndex i=1; i<=(yyvsp[-1].pGroup)->list->GetElementCount(); i++)
			{
			itsCurrentNode->Append((yyvsp[-1].pGroup)->list->GetElement(i));
			}
...
#line 1494 "code/GDBVarTreeParserY.cpp"
    break;

  case 4:
#line 122 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, *(yyvsp[-1].pString));
...
#line 1508 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 133 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, *(yyvsp[-2].pString));
		CMVarNode* child = CMGetLink()->CreateVarNode(itsCurrentNode, JString::empty, JString::empty, *(yyvsp[-1].pString));
...
#line 1524 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1533 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1542 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1556 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1565 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1574 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1588 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1598 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1607 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 211 "code/GDBVarTreeParserY.y"
		...
		CMVarNode* node = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, *(yyvsp[0].pString));
...
#line 1627 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1641 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1664 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1674 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 269 "code/GDBVarTreeParserY.y"
		...
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, *(yyvsp[-1].pString), JString::empty, *(yyvsp[0].pString));
...
#line 1696 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 288 "code/GDBVarTreeParserY.y"
		...
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, *(yyvsp[-1].pString), JString::empty, (yyvsp[0].pGroup)->GetName());
		itsIsPointerFlag = false;
...
#line 1718 "code/GDBVarTreeParserY.cpp"
    break;

  case 20:
#line 307 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, *(yyvsp[0].pString), JString::empty, JString::empty);
		itsIsPointerFlag = false;

		jdelete (yyvsp[0].pString);
		}
#line 1729 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 315 "code/GDBVarTreeParserY.y"
		...
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, *(yyvsp[0].pString), JString::empty, JString("<nothing>", JString::kNoCopy));
		itsIsPointerFlag = false;

		jdelete (yyvsp[0].pString);
		}
#line 1746 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1758 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1770 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1781 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1795 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1805 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1814 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1824 "code/GDBVarTreeParserY.cpp"
    break;

  case 32:
#line 403 "code/GDBVarTreeParserY.y"
                {
		itsCurrentNode = (yyval.pNode) = CMGetLink()->CreateVarNode(nullptr, JString::empty, JString::empty, *(yyvsp[0].pString));
		itsCurrentNode->MakePointer(itsIsPointerFlag);
		itsIsPointerFlag = false;

		jdelete (yyvsp[0].pString);
		}
#line 1836 "code/GDBVarTreeParserY.cpp"
    break;

  case 37:
#line 423 "code/GDBVarTreeParserY.y"
                {
		itsIsPointerFlag = cmIsOpenablePointer(*(yyvsp[0].pString));
		(yyval.pString) = (yyvsp[0].pString);
		}
#line 1845 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1855 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1868 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1880 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1895 "code/GDBVarTreeParserY.cpp"
    break;

  case 44:
#line 471 "code/GDBVarTreeParserY.y"
                {
		itsIsPointerFlag = cmIsOpenablePointer(*(yyvsp[-1].pString));
		(yyval.pString) = (yyvsp[-1].pString);
		(yyval.pString)->Append(" ");
		(yyval.pString)->Append(*(yyvsp[0].pString));
...
#line 1908 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1920 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1932 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1944 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1956 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1970 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1982 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 1994 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 2003 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 2015 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 2027 "code/GDBVarTreeParserY.cpp"
    break;
...
#line 2040 "code/GDBVarTreeParserY.cpp"
    break;


#line 2044 "code/GDBVarTreeParserY.cpp"
