// code/CBCSharpScanner.h generated by reflex 3.0.11 from code/CBCSharpScanner.ll

#ifndef REFLEX_CODE_CBCSHARPSCANNER_H
#define REFLEX_CODE_CBCSHARPSCANNER_H
#define IN_HEADER 1
