// code/CBBourneShellScanner.h generated by reflex 3.0.11 from code/CBBourneShellScanner.ll

#ifndef REFLEX_CODE_CBBOURNESHELLSCANNER_H
#define REFLEX_CODE_CBBOURNESHELLSCANNER_H
#define IN_HEADER 1
