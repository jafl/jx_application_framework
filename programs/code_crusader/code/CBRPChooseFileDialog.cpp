...
// begin JXLayout
	...
	JXTextRadioButton* obj1_JXLayout =
		jnew JXTextRadioButton(CBRelPathCSF::kAbsolutePath, JGetString("obj1_JXLayout::CBRPChooseFileDialog::JXLayout"), itsPathTypeRG,
					JXWidget::kFixedLeft, JXWidget::kFixedTop, 10,10, 180,20);
	assert( obj1_JXLayout != NULL );

	JXTextRadioButton* obj2_JXLayout =
		jnew JXTextRadioButton(CBRelPathCSF::kProjectRelative, JGetString("obj2_JXLayout::CBRPChooseFileDialog::JXLayout"), itsPathTypeRG,
