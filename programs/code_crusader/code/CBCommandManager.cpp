/******************************************************************************
 CBCommandManager.cpp
	...
	Copyright (C) 2001-18 by John Lindal.
...
static const DefCmd kDefCmd[] =
{
	...
	{ "@", "git log -p $file_name",
		...
		kJFalse },
	{ "./", "git checkout $relative_name; jcc --reload-open",
		"",
