// code/CBCShellScanner.h generated by reflex 3.0.11 from code/CBCShellScanner.ll

#ifndef REFLEX_CODE_CBCSHELLSCANNER_H
#define REFLEX_CODE_CBCSHELLSCANNER_H
#define IN_HEADER 1
