...
JBoolean
JPlotFitBase::GetGoodnessOfFitName
	(
	JString* name
	)
	const
...
JSize
JPlotFitBase::GetRealElementCount()
{
...
JString
JPlotFitBase::GetFunctionString()
	const
{
...
JString
JPlotFitBase::GetFitFunctionString()
	const
{
	return itsFunctionStr;
}
