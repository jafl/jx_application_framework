	...
	JPlotFitFunction(plot, fitData, xMin, xMax)
{
	...
	JPlotFitQuad junk(plot, fitData, xMin, xMax);
//	JPlotFitQuad2 junk2(plot, fitData, xMin, xMax);
}
...
JBoolean
JPlotQuadFit::GetGoodnessOfFitName
	(
	JString* name
	)
	const
