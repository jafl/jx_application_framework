...
JBoolean
JPlotFitQuad2::GetParameterName
	(
	const JIndex index, 
	JString* name
	)
...
JBoolean
JPlotFitQuad2::GetParameterError
	(
	const JIndex index, 
	JFloat* value
	)
...
JString
JPlotFitQuad2::GetFunctionString()
	const
{
...
JString
JPlotFitQuad2::GetFitFunctionString()
	const
{
	return itsFunctionName;
}
