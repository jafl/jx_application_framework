...
JTEST(Split)
{
	...
	JAssertEqual(8, list.GetItemCount());
	JAssertStringsEqual("", *list.GetItem(1));
	JAssertStringsEqual("  ", *list.GetItem(2));
	JAssertStringsEqual("foo", *list.GetItem(3));
	JAssertStringsEqual(" ", *list.GetItem(4));
	JAssertStringsEqual("bar", *list.GetItem(5));
	JAssertStringsEqual("  ", *list.GetItem(6));
	JAssertStringsEqual("baz", *list.GetItem(7));
	JAssertStringsEqual(" ", *list.GetItem(8));

	s.TrimWhitespace();

	s.Split(regex, &list, 2);
	JAssertEqual(2, list.GetItemCount());
	JAssertStringsEqual("foo", *list.GetItem(1));
	JAssertStringsEqual("bar  baz", *list.GetItem(2));
