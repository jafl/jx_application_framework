/******************************************************************************
 THX3DPlotFunctionDialog.cpp
	...
	Copyright (C) 1998-2005 by John Lindal.
...
// begin JXLayout
	...
	JXWindow* window = jnew JXWindow(this, 440,300, "");
	assert( window != NULL );
	...
	JXTextButton* cancelButton =
		jnew JXTextButton(JGetString("cancelButton::THX3DPlotFunctionDialog::JXLayout"), window,
					JXWidget::kHElastic, JXWidget::kVElastic, 110,270, 60,20);
	assert( cancelButton != NULL );

	JXTextButton* okButton =
		jnew JXTextButton(JGetString("okButton::THX3DPlotFunctionDialog::JXLayout"), window,
	...
	JXStaticText* obj2_JXLayout =
		jnew JXStaticText(JGetString("obj2_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
					JXWidget::kFixedLeft, JXWidget::kFixedBottom, 10,170, 90,20);
	assert( obj2_JXLayout != NULL );
	obj2_JXLayout->SetToLabel();

	JXStaticText* obj3_JXLayout =
		jnew JXStaticText(JGetString("obj3_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
					JXWidget::kFixedLeft, JXWidget::kFixedBottom, 10,200, 90,20);
	assert( obj3_JXLayout != NULL );
	obj3_JXLayout->SetToLabel();

	JXStaticText* obj4_JXLayout =
		jnew JXStaticText(JGetString("obj4_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
					JXWidget::kFixedLeft, JXWidget::kFixedBottom, 180,200, 20,20);
	assert( obj4_JXLayout != NULL );
	obj4_JXLayout->SetToLabel();

	JXStaticText* obj5_JXLayout =
		jnew JXStaticText(JGetString("obj5_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
					JXWidget::kFixedLeft, JXWidget::kFixedBottom, 10,230, 90,20);
	assert( obj5_JXLayout != NULL );
	obj5_JXLayout->SetToLabel();

	JXStaticText* obj6_JXLayout =
		jnew JXStaticText(JGetString("obj6_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
	...
	JXStaticText* obj7_JXLayout =
		jnew JXStaticText(JGetString("obj7_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
	...
	JXStaticText* obj8_JXLayout =
		jnew JXStaticText(JGetString("obj8_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
	...
	JXStaticText* obj9_JXLayout =
		jnew JXStaticText(JGetString("obj9_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
	...
	JXStaticText* obj10_JXLayout =
		jnew JXStaticText(JGetString("obj10_JXLayout::THX3DPlotFunctionDialog::JXLayout"), window,
