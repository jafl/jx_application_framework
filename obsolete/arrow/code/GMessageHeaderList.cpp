...
//			JExecute(cmd, NULL);
		...
		*list = new GMessageHeaderList(mailfile, pg);
		assert(*list != NULL);
		}
	else
		{
...
GMessageHeaderList::GMessageHeaderList
	(
	const JString&		mailfile,
	JProgressDisplay*	pg
	)
