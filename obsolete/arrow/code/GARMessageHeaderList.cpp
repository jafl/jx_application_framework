...
//Class Header
#include <GARMessageHeaderList.h>
#include <GMScanner.h>
#include <GPrefsMgr.h>
#include <GMGlobals.h>
...
JBoolean
GARMessageHeaderList::OkToCreate
	(
...
JBoolean
GARMessageHeaderList::Create
	(
	const JString&			mailfile,
	GARMessageHeaderList**	list,
	JProgressDisplay*		pg
	)
{
...
//			JExecute(cmd, NULL);
		...
		*list = new GARMessageHeaderList(mailfile, pg);
		assert(*list != NULL);
		}
	else
		{
...
GARMessageHeaderList::GARMessageHeaderList
	(
	const JString&		mailfile,
	JProgressDisplay*	pg
	)
