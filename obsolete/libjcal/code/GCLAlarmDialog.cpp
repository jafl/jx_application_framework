...
// begin JXLayout
	...
	JXWindow* window = jnew JXWindow(this, 390,250, "");
	assert( window != NULL );

	itsHelpButton =
		jnew JXTextButton(JGetString("itsHelpButton::GCLAlarmDialog::JXLayout"), window,
					JXWidget::kHElastic, JXWidget::kVElastic, 80,220, 70,20);
	assert( itsHelpButton != NULL );

	JXTextButton* okButton =
		jnew JXTextButton(JGetString("okButton::GCLAlarmDialog::JXLayout"), window,
	...
	itsStatusText =
		jnew JXStaticText(JGetString("itsStatusText::GCLAlarmDialog::JXLayout"), window,
	...
	JXTextRadioButton* obj1_JXLayout =
		jnew JXTextRadioButton(1, JGetString("obj1_JXLayout::GCLAlarmDialog::JXLayout"), itsRG,
					JXWidget::kHElastic, JXWidget::kVElastic, 10,0, 140,20);
	assert( obj1_JXLayout != NULL );

	JXTextRadioButton* obj2_JXLayout =
		jnew JXTextRadioButton(2, JGetString("obj2_JXLayout::GCLAlarmDialog::JXLayout"), itsRG,
					JXWidget::kHElastic, JXWidget::kVElastic, 10,20, 150,20);
	assert( obj2_JXLayout != NULL );

	itsAmountInput =
		jnew JXIntegerInput(itsRG,
					JXWidget::kHElastic, JXWidget::kVElastic, 160,0, 80,20);
	assert( itsAmountInput != NULL );

	itsTimeUnitMenu =
		jnew JXTextMenu(JGetString("itsTimeUnitMenu::GCLAlarmDialog::JXLayout"), itsRG,
					JXWidget::kHElastic, JXWidget::kVElastic, 240,0, 100,20);
	assert( itsTimeUnitMenu != NULL );

	JXStaticText* obj3_JXLayout =
		jnew JXStaticText(JGetString("obj3_JXLayout::GCLAlarmDialog::JXLayout"), window,
					JXWidget::kHElastic, JXWidget::kVElastic, 20,10, 350,20);
	assert( obj3_JXLayout != NULL );

	JXStaticText* obj4_JXLayout =
		jnew JXStaticText(JGetString("obj4_JXLayout::GCLAlarmDialog::JXLayout"), window,
	...
	itsSubjectText =
		jnew JXStaticText(JGetString("itsSubjectText::GCLAlarmDialog::JXLayout"), window,
	...
	JXStaticText* obj5_JXLayout =
		jnew JXStaticText(JGetString("obj5_JXLayout::GCLAlarmDialog::JXLayout"), window,
	...
	itsTimeText =
		jnew JXStaticText(JGetString("itsTimeText::GCLAlarmDialog::JXLayout"), window,
	...
	itsDateText =
		jnew JXStaticText(JGetString("itsDateText::GCLAlarmDialog::JXLayout"), window,
...
GCLAlarmDialog::OKToDeactivate()
{
	...
	GCLAlarm* alarm	= jnew GCLAlarm(value, GetTimeUnit(), appt, itsAlarm->GetApptDay(), itsAlarm->GetApptTime(), kJTrue);
	assert(alarm != NULL);
...
GCLAlarmDialog::AddNextAlarm()
{
	...
	if (appt->GetRecurrence(&r) && r.type != kNoRepeat &&
		...
		GCLAlarm* alarm	= jnew GCLAlarm(value, unit, appt, day, appt->GetStartTime(), kJFalse);
		assert(alarm != NULL);
		GCLGetAlarmMgr()->AddAlarm(alarm);
