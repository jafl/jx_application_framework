...
Source: %pkg_name
Requires: gcc-c++, make, rpm-build, imake, libtool, libX11-devel, libXinerama-devel, libXft-devel, libXmu-devel, libXi-devel, xorg-x11-proto-devel, xorg-x11-server-devel, libXdamage-devel, libXpm-devel, libjpeg-devel, libpng-devel, gd-devel, libicu-devel, pcre-devel, libxml2-devel, boost-devel, expat-devel, libdrm-devel, xforms-devel, aspell, aspell-en, findutils, curl, perl, python-libxml2, xdg-utils, ImageMagick
