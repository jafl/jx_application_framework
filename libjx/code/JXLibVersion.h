...
//		*** Removed useless idNamespace argument for SetMenuItems().
//	JXDocumentManager:
...
//	JXHistoryMenuBase:
//		Added HistoryDirection to support menus that are anchored near the
