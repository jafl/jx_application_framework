...
// begin JXLayout
	...
	itsPrintReverseOrderCB->SetShortcuts(JGetString("itsPrintReverseOrderCB::shortcuts::JXPTPageSetupDialog::JXLayout"));
	...
	okButton->SetShortcuts(JGetString("okButton::shortcuts::JXPTPageSetupDialog::JXLayout"));
