...
// begin JXLayout
	...
	JXStaticText* cmdLabel =
		jnew JXStaticText(JGetString("cmdLabel::JXPTPageSetupDialog::JXLayout"), window,
	...
	JXStaticText* charLabel =
		jnew JXStaticText(JGetString("charLabel::JXPTPageSetupDialog::JXLayout"), window,
					JXWidget::kFixedRight, JXWidget::kFixedTop, 130,60, 70,20);
	assert( charLabel != NULL );
	charLabel->SetToLabel();

	JXStaticText* lineLabel =
		jnew JXStaticText(JGetString("lineLabel::JXPTPageSetupDialog::JXLayout"), window,
